...
trained_model = 'trained_checkpoints/linemod/ape/pose_model_9_0.009813725374018152.pth'
refine_model = 'trained_checkpoints/linemod/ape/pose_refine_model_299_0.0033653128481957884.pth'
obj_num = 1
...
cv2.imwrite('pose_{}_{:04d}.png'.format(obj_id, img_id), vis_im_rgb[...,::-1])
